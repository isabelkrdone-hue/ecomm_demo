...
class _AddProductPageState extends State<AddProductPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.existingProduct == null ? 'Jual Produk' : 'Edit Produk'),
        backgroundColor: Colors.white,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _label('Nama Produk'),
                  const SizedBox(height: 8),
                  _textField(controller: _nameController, hintText: 'Contoh: Sepatu Running'),
                  const SizedBox(height: 16),
                  _label('Harga'),
                  const SizedBox(height: 8),
                  _textField(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: _isSaving
                          ...
                          : Text(
                              widget.existingProduct == null ? 'Tambah Produk' : 'Simpan Perubahan',
